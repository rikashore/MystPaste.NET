...
namespace MystPaste.NET
{
    ...
    public class TimeClient : ApiClient
    {
        ...
        public Task<Timestamp> GetExpiresWhenTimestamp(long createdAt, string durationType)
        {
        ...
        {
            return ApiRequester.Get<Timestamp>(ApiUrls.ExpirationTimestamp(createdAt, expiresIn));
        }
    }
}